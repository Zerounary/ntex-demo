<template>
  <div class="chains-page min-h-screen p-6 md:p-10 lg:p-14">
    <div class="mb-8 animate-slide-up">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          ...
          <p class="text-gray-500 font-medium">Maintain chain routing tables per node</p>
        </div>
    ...
    <div v-if="!selectedNodeId" class="flex flex-col items-center justify-center py-28 animate-fade-in">
