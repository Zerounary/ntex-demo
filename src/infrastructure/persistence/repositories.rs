...
fn node_into_active_model(node: Node) -> accelerator_node::ActiveModel {
    accelerator_node::ActiveModel {
        id: Set(node.id),
        vless_id: Set(node.vless_id),
        vless_server: Set(node.vless_server),
        vless_port: Set(node.vless_port),
        vless_encryption: Set(node.vless_encryption),
        reality_server_name: Set(node.reality_server_name),
        reality_public_key: Set(node.reality_public_key),
        reality_short_id: Set(node.reality_short_id),
        reality_fingerprint: Set(node.reality_fingerprint),
        reality_spider_x: Set(node.reality_spider_x),
